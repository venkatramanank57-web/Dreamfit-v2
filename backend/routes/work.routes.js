...
// routes/work.routes.js - UPDATED WITH PROPER AUTHORIZATION
import express from 'express';
import { protect, authorize } from '../middleware/auth.middleware.js';
import {
  createWorksFromOrder,
...
// ============================================
// ✅ DASHBOARD ROUTES (Accessible by Admin & Store Keeper)
// ============================================
...
/**
 * @route   GET /api/works/dashboard/master-stats
 * @desc    Get cutting master dashboard stats
 * @access  Cutting Master, Admin, Store Keeper
 */
router.get(
...
/**
 * @route   GET /api/works/dashboard/tailors
 * @desc    Get tailor performance for cutting master
 * @access  Cutting Master, Admin, Store Keeper
 */
router.get(
  '/dashboard/tailors',
...
/**
 * @route   GET /api/works/dashboard/calendar
 * @desc    Get calendar work data
 * @access  Cutting Master, Admin, Store Keeper
 */
router.get(
  '/dashboard/calendar',
...
/**
 * @route   GET /api/works/dashboard/today
 * @desc    Get today's summary for master
 * @access  Cutting Master, Admin, Store Keeper
 */
router.get(
  '/dashboard/today',
 ...
 * @route   GET /api/works/tailor-works
 * @desc    Get works assigned to the logged-in tailor
 * @access  Tailor, Admin, Store Keeper
 */
router.get(
  '/tailor-works', 
  authorize('TAILOR', 'ADMIN', 'STORE_KEEPER'), 
  getWorksByTailor
);
