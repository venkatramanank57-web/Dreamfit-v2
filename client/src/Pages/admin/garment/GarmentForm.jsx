...
//                     >
//                       <Calendar size={14} className="text-slate-400 sm:w-4 sm:h-4 flex-shrink-0" />
//                       <span className={`truncate ${formData.estimatedDelivery ? "text-slate-800" : "text-slate-400"}`}>
//                         {formatDisplayDate(formData.estimatedDelivery)}
//                       </span>
//                       {calendarLoading && (
...
//                         {customerOrderDates && customerOrderDates.length > 0 && (
//                           <p className="text-[8px] sm:text-xs text-red-600 mt-2">
//                             {customerOrderDates.length} booked date(s) this month
//                           </p>
//                         )}
//                       </div>
...
//                   />
//                   <span className="text-[10px] sm:text-xs font-medium">Customer Provided</span>
//                 </label>
//                 <label className="flex items-center gap-2 cursor-pointer">
//                   <input
//                     type="radio"
...
//                     className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600"
//                   />
//                   <span className="text-[10px] sm:text-xs font-medium">Shop Provided</span>
//                 </label>
//               </div>
...
//             {/* Price Range & Total Display */}
//             <div className="bg-slate-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
//               <h3 className="font-black text-slate-800 text-sm sm:text-base mb-3 sm:mb-4">Pricing</h3>
              
//               <div className="mb-3 sm:mb-4 p-2 sm:p-3 bg-blue-50 rounded-lg border border-blue-200">
//                 <p className="text-[8px] sm:text-xs text-blue-600 font-bold mb-1">Item Price</p>
//                 <div className="grid grid-cols-2 gap-2 sm:gap-4 text-xs sm:text-sm">
//                   <div>
//                     <span className="text-slate-600">Min:</span>
//                     <span className="ml-1 sm:ml-2 font-bold text-blue-700">₹{formData.priceRange.min || 0}</span>
//                   </div>
//                   <div>
//                     <span className="text-slate-600">Max:</span>
//                     <span className="ml-1 sm:ml-2 font-bold text-blue-700">₹{formData.priceRange.max || 0}</span>
//                   </div>
//                 </div>
//               </div>
...
//                   <p className="text-[8px] sm:text-xs text-green-600 font-bold mb-1">Fabric Price</p>
//                   <div className="text-xs sm:text-sm">
//                     <span className="text-slate-600">Fabric Cost:</span>
//                     <span className="ml-1 sm:ml-2 font-bold text-green-700">₹{formData.fabricPrice.toFixed(2)}</span>
//                   </div>
//                 </div>
//               )}

//               <div className="p-3 sm:p-4 bg-purple-50 rounded-lg sm:rounded-xl border-2 border-purple-300">
//                 <p className="text-[8px] sm:text-xs text-purple-600 font-bold mb-2">TOTAL GARMENT PRICE</p>
//                 <div className="grid grid-cols-2 gap-2 sm:gap-4 text-sm sm:text-base">
//                   <div>
//                     <span className="text-slate-600 text-xs">Min:</span>
//                     <span className="ml-1 sm:ml-2 text-base sm:text-lg font-black text-purple-700">₹{totals.totalMin}</span>
//                   </div>
//                   <div>
//                     <span className="text-slate-600 text-xs">Max:</span>
//                     <span className="ml-1 sm:ml-2 text-base sm:text-lg font-black text-purple-700">₹{totals.totalMax}</span>
//                   </div>
//                 </div>
//                 <p className="text-[8px] sm:text-xs text-purple-500 mt-2">
//                   * Tailoring (₹{formData.priceRange.min} - ₹{formData.priceRange.max}) 
//                   {formData.fabricSource === "shop" && formData.fabricPrice > 0 ? ` + Fabric (₹${formData.fabricPrice})` : ''}
//                 </p>
//               </div>
//             </div>
...
//                 <h3 className="font-black text-slate-800 text-sm sm:text-base">Measurements</h3>
...
//                     className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600"
//                   />
//                   <span className="text-[10px] sm:text-xs font-medium">Use Template</span>
//                 </label>
...
//                     className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600"
//                   />
//                   <span className="text-[10px] sm:text-xs font-medium">Manual Entry</span>
//                 </label>
//               </div>
...
//               {formData.measurementSource === "manual" && (
//                 <div className="space-y-3">
//                   <p className="text-xs sm:text-sm text-slate-600">Enter measurements manually</p>
//                   <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
//                     {fields?.map((field) => (
//                       <div key={field._id}>
//                         <label className="block text-[8px] sm:text-xs font-medium text-slate-600 mb-1 truncate">
...
//                     <h4 className="font-bold text-slate-800 text-xs sm:text-sm">Studio Reference Images</h4>
//                     <p className="text-[8px] sm:text-xs text-slate-500">Designer images, style references</p>
//                   </div>
//                 </div>
...
//                       <Upload size={14} className="text-slate-400 mb-1 sm:w-5 sm:h-5" />
//                       <span className="text-[8px] sm:text-xs text-slate-500">Upload</span>
//                       <input
//                         type="file"
//                         multiple
//                         accept="image/*"
...
//                     </label>
//                   </div>
//                   <p className="text-[8px] sm:text-xs text-slate-400">Max 5MB per image</p>
//                 </div>
//               </div>
...
//                   </div>
//                   <div className="min-w-0">
//                     <h4 className="font-bold text-slate-800 text-xs sm:text-sm">Customer Digital Images</h4>
//                     <p className="text-[8px] sm:text-xs text-slate-500">Photos sent by customer</p>
//                   </div>
//                 </div>
...
//                   </div>
//                   <div className="min-w-0">
//                     <h4 className="font-bold text-slate-800 text-xs sm:text-sm">Customer's Reference Cloth</h4>
//                     <p className="text-[8px] sm:text-xs text-slate-500">Photos of physical cloth/design</p>
//                   </div>
//                 </div>
...
//                       <Upload size={14} className="text-orange-400 mb-1 sm:w-5 sm:h-5" />
//                       <span className="text-[8px] sm:text-xs text-orange-600 font-medium">Upload</span>
//                       <input
//                         type="file"
//                         multiple
//                         accept="image/*"
...
//       {/* Save Template Modal - Responsive */}
//       {showSaveTemplateModal && (
//         <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
//           <div className="bg-white w-full max-w-md rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden mx-4">
//             <div className="p-4 sm:p-6">
//               <h3 className="text-base sm:text-lg lg:text-xl font-black text-slate-800 mb-2">Save as Template</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            <div className="bg-slate-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-4 mb-3 sm:mb-4">
                ...
                {/* ✅ CUSTOMER SAVED TEMPLATES OPTION - ADDED BACK */}
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="radio"
                    name="measurementSource"
                    ...
                    className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600"
                  />
                  <span className="text-[10px] sm:text-xs font-medium">Customer Templates</span>
                </label>
              ...
              {/* ✅ CUSTOMER TEMPLATES DROPDOWN - ADDED BACK */}
              {formData.measurementSource === "customer" && (
                <div className="mb-4">
                  <label className="block text-[8px] sm:text-xs font-black uppercase text-slate-500 mb-1 sm:mb-2">
                    Select Saved Template
                  ...
                  {!effectiveCustomerId ? (
                    ...
                    <div className="flex items-center gap-2 p-2 sm:p-3 bg-slate-100 rounded-lg">
                      ...
                      <span className="text-xs sm:text-sm text-slate-600">Loading templates...</span>
                    </div>
                  ) : customerTemplates?.length > 0 ? (
                    <select
                      value={selectedCustomerTemplate}
                    ...
                    >
                      ...
                      {customerTemplates.map((template) => (
                        <option key={template._id} value={template._id}>
                          {template.name} {template.usageCount ? `(Used ${template.usageCount} times)` : ''}
                        </option>
                      ))}
                    </select>
                  ) : (
              ...
              {/* ✅ CUSTOMER TEMPLATE LOADED CONTENT - ADDED BACK */}
              {formData.measurementSource === "customer" && selectedCustomerTemplate && (
                <div className="space-y-3">
