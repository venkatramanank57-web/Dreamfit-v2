...
//   const [searchQuery, setSearchQuery] = useState("");
//   const [sidebarOpen, setSidebarOpen] = useState(false);
//   const [desktopSidebarOpen, setDesktopSidebarOpen] = useState(true); // New state for desktop drawer
...
//         setDesktopSidebarOpen(true); // Open desktop drawer by default
...
//           Dreamfit <span className="text-blue-500 font-extrabold italic">Couture</span>
//         </h2>
//         {/* Close button - only show on mobile or when desktop sidebar is toggled */}
//         <button
//           onClick={() => {
//             if (window.innerWidth >= 1024) {
//               setDesktopSidebarOpen(false);
...
//         <button
//           onClick={toggleSidebar}
//           className="p-2 bg-white border border-slate-200 rounded-lg shadow-sm hover:bg-slate-50 text-slate-600 transition-all"
...
//       {/* --- LEFT SIDEBAR - Desktop Drawer Style --- */}
//       <aside className={`
//         fixed lg:absolute lg:left-0 top-0 bottom-0 z-40
//         w-72 bg-[#0F172A] text-slate-300 flex flex-col shadow-2xl
...
//   const SidebarContent = () => (
//     <>
//       {/* Sidebar Header - Company Name in 2 Lines */}
//       <div className={`h-24 border-b border-slate-800 bg-[#0F172A] flex items-center transition-all duration-300 ${
//         !desktopSidebarOpen && window.innerWidth >= 1024 ? 'justify-center px-0' : 'justify-between px-6'
//       }`}>
//         {/* Company Name: 2 lines with better styling */}
...
//         }`}>
//           <h2 className="text-xl font-black text-white tracking-wider uppercase leading-tight">
//             Dreamfit
//           </h2>
//           <h2 className="text-lg font-black text-blue-500 tracking-wider uppercase italic leading-tight -mt-1">
//             Couture
//           </h2>
//         </div>
...
//         {/* Desktop Toggle Button inside Sidebar when CLOSED */}
...
//       {/* SEARCH - Hide when sidebar is collapsed */}
...
//       {/* NAV LINKS */}
//       <nav className={`flex-1 px-3 space-y-1 overflow-y-auto mt-2 custom-scrollbar-hidden transition-all duration-300 ${
...
//                     if (item.id === 'reports') setReportsOpen(!reportsOpen);
//                   }}
//                   className={`w-full nav-link flex justify-between items-center transition-all duration-300 ${
...
//                         key={sub.id} 
//                         to={sub.path} 
//                         className={`flex items-center gap-2 py-2 text-sm text-slate-500 hover:text-blue-400 transition-all duration-300 ${
...
//                   {item.label}
//                 </span>
//                 {isActive(item.path) && <span className={`ml-auto w-1.5 h-1.5 bg-white rounded-full transition-all duration-300 ${
//                   !desktopSidebarOpen && window.innerWidth >= 1024 ? 'hidden' : 'block'
//                 }`}></span>}
//               </Link>
//             )}
...
//       {/* FOOTER STATS - Hide when sidebar is collapsed */}
...
//       {/* Desktop Toggle Button - Dynamic positioning */}
...
//         {/* Scrollable Content */}
//         <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar pt-16 md:pt-0">
...
//   // Sidebar content component with LOGO
//   const SidebarContent = () => (
//     <>
//       {/* Sidebar Header - Logo + Company Name in 2 Lines */}
//       <div className={`border-b border-slate-800 bg-[#0F172A] flex items-center transition-all duration-300 ${
//         !desktopSidebarOpen && window.innerWidth >= 1024 ? 'justify-center px-0 py-4' : 'justify-between px-6 py-4'
//       }`}>
...
//           {/* <div className="flex flex-col">
//             <h2 className="text-sm font-black text-white tracking-wider uppercase leading-tight">
//               Dreamfit
//             </h2>
//             <h2 className="text-xs font-black text-blue-500 tracking-wider uppercase italic leading-tight -mt-1">
//               Couture
//             </h2>
//           </div> */}
//           <div className="flex flex-col select-none">
//   <h2 className="text-2xl font-[1000] text-white tracking-tighter uppercase leading-none">
//     Dreamfit
//   </h2>
//   <h2 className="text-lg font-black text-blue-500 tracking-[0.2em] uppercase italic leading-none mt-1">
//     Couture
//   </h2>
// </div>
//         </div>
...
//   // Sidebar content component with LOGO and LARGER COMPANY NAME
//   const SidebarContent = () => (
//     <>
...
//           />
//           {/* Company Name - 2 lines with larger font */}
//           <div className="flex flex-col">
...
//         /* Better responsive handling for tables and grids */
...
//   // ✅ NEW: Ref for active link to auto-scroll sidebar
...
//   // ✅ NEW: Auto-scroll sidebar to active link when page changes
//   useEffect(() => {
...
//           behavior: "smooth",
//           block: "nearest", // Scrolls just enough to show the element without jumping too far
//         });
//       }
//     }, 100);
...
//   // ✅ Function to check if any banking sub-item is active
//   const isBankingActive = () => {
//     return bankingItems.some(item => isActive(item.path));
//   };

//   // ✅ Function to check if any reports sub-item is active
...
//       }`}>
//         {filteredNavItems.map((item) => {
//           // Check if this specific item is active (for non-dropdown) or if dropdown has active sub-item
//           const isItemActive = item.isDropdown 
//             ? (item.id === 'banking' && isBankingActive()) || (item.id === 'reports' && isReportsActive())
//             : isActive(item.path);
          
//           // ✅ NEW: Auto-open dropdown if a sub-item is active
//           useEffect(() => {
//             if (item.id === 'banking' && isBankingActive() && !bankingOpen) {
//               setBankingOpen(true);
//             }
//             if (item.id === 'reports' && isReportsActive() && !reportsOpen) {
//               setReportsOpen(true);
//             }
//           }, [location.pathname]);
...
//             <div 
//               key={item.id} 
//               // ✅ NEW: Add ref to the active link element for auto-scroll
...
//                               isSubActive ? 'text-blue-400 font-medium' : 'text-slate-500 hover:text-blue-400'
//                             } ${!desktopSidebarOpen && window.innerWidth >= 1024 ? 'justify-center' : ''}`}
//                             onClick={closeSidebar}
//                             title={!desktopSidebarOpen && window.innerWidth >= 1024 ? sub.label : ""}
//                           >
...
//   // ✅ Fixed: useEffect moved outside of render loop
//   useEffect(() => {
...
//         {/* Right: User Icon with Dropdown + Notification Bell */}
//         <div className="flex items-center gap-2">
//           <NotificationBell />
...
//               className="flex items-center gap-1 p-2 hover:bg-slate-100 rounded-lg text-slate-600 transition-colors"
//             >
//               <UserCircle size={24} />
//               <ChevronDown size={16} />
//             </button>
...
//             {/* User Menu Dropdown */}
//             {userMenuOpen && (
//               <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-slate-200 py-2 z-70">
